...
enum  {
    ...
    WOLFKM_BAD_MEMORY        = -1003,
    WOLFKM_BAD_FILE          = -1004,
    WOLFKM_BAD_KEY           = -1005,
    WOLFKM_BAD_CERT          = -1006,
    WOLFKM_BAD_SEND          = -1007,
    WOLFKM_BAD_LISTENER      = -1008,
    WOLFKM_NOT_COMPILED_IN   = -1009,
    WOLFKM_BAD_HOST          = -1010,
    WOLFKM_BAD_TIMEOUT       = -1011,
